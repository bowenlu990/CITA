...
# from parse1 import parser_add_main_args
# from model import *
from model import *
import time
# from dataset1 import load_amazon_dataset, load_reddit_dataset, load_products_dataset, load_yelpchi_dataset, load_mag_dataset, load_webkb_dataset1
...
if args.cpu:
    device = torch.device("cpu")#如data和model的设备分配，以及指定设备序号。
else:
...
#     dataset= load_amazon_dataset(args.data_dir, args.dataset, train_num=5)
# elif args.dataset == 'products':
#     dataset = load_products_dataset(args.data_dir, train_num=5)
# elif args.dataset == 'mag':
#     dataset = load_mag_dataset(args.data_dir, train_num=5)
# elif args.dataset == 'reddit':
#     dataset = load_reddit_dataset(args.data_dir, train_num=5)
# elif args.dataset == 'yelpchi':
#     dataset = load_yelpchi_dataset(args.data_dir, train_num_ratio=0.8)
# elif args.dataset == 'webkb':
#     dataset = load_webkb_dataset1(args.data_dir, train_num=2)
else:
...
# node_edges=dataset.num_edges+n

model = CausalFrontNet(d, c, n, dataset.num_edges, args, device).to(device)
